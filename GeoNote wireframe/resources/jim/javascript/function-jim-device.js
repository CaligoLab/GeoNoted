...
(function(window, undefined) {
	  ...
	  var jimDevice = {
		 ...
		 "isiPhone" : function(){
			 if(jimDevice.name.toLowerCase().indexOf("iphone")>=0)
				 return true;
			 return false;
		 },
		 "isAndroid" : function() {
		 ...
		 "isAndroidNamed" : function() {
			 if(jimDevice.name.toLowerCase().indexOf("galaxys22")>=0 || jimDevice.name.toLowerCase().indexOf("pixel6")>=0)
				 return true;
			 return false;
		 },
		 "isAndroidPhone" : function(){
			 if(jimDevice.name.toLowerCase().indexOf("androidphone")>=0)
				 return true;
			 return false;
		 },
		 "isAndroidTablet" : function(){
			 if(jimDevice.name.toLowerCase().indexOf("androidtablet")>=0)
				 return true;
			 return false;
		 },
		 "isCustom" : function(){
		...
		"loadDeviceSimulator": function() {
		 ...
		 "getZoom": function() {
		  ...
		  "getController" : function(){
		  	 if(jimDevice.name.toLowerCase().includes("iphone") || jimDevice.name.toLowerCase().includes("ipad"))
				 return jimDevice.controllers.iOS15;
			 else if(jimDevice.name.toLocaleLowerCase().indexOf("android")>=0)
				 return jimDevice.controllers.android12;
			 else

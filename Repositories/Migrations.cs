...
namespace Geonote.Repositories
{
    public class Migrations
    {
        ...
        public static void Run() // TA: Create a checkup if this method has been already run to avoid trying to make duplicates and crushing the app
        {
            ...
            SQLTableManagement.CreateTable("CREATE TABLE Place (Id VARCHAR(20) NOT NULL, Name VARCHAR(200) NOT NULL, AddressId VARCHAR(300), Type VARCHAR(30), Comment VARCHAR(300), LocationId VARCHAR(20), PRIMARY KEY(Id))");
